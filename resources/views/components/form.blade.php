...
<a id="forgot" onclick="mostrar()">¿Forgot ur password?</a>

</form>

<dialog id="dialog" class="w-50 flex-row border-0 ">

  <button class="btn" onclick="cerrar()">x</button>
  <label for="forgot" class="form-check-label input m-2">Introduce tu email</label>
  <input type="email" class="form-check-input w-50 input m-2" name="" id="forgot">
