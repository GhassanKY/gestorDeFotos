...
function mostrar() { 
	let dialogo = document.getElementById('dialog').showModal();
	dialogo.classList.add("d-flex")
 }
 function cerrar() { 
	let dialogo = document.getElementById('dialog').close();
 }